...
for(var i = 0; i < l; i++) {
  images[i].addEventListener("click", function(i) {
    ...
    screenItem.innerHTML = '<div class="gg-image"></div><div class="gg-close">&times</div><div class="gg-next gg-btn">&#8250;</div><div class="gg-prev gg-btn">&#8249;</div><div id="show-caption"></div>';
    ...
    document.getElementById("show-caption").innerHTML = currentImg.alt; //display caption
    if (l > 1) {
      if (route == first) {
        prevBtn.hidden = true;
        var prevImg = false;
